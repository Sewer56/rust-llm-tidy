<!-- Benchmark fixture: laminar reliability/ordering guide. -->
<!-- medium tier; clean for fix_links (single-use inline links only, borrowed no-op). -->
<!-- Source (pinned): https://github.com/TimonPost/laminar/blob/e8ffb26a915bb6ac3c8d959031d63f8a776e763c/docs/md_book/src/reliability/ordering.md -->
