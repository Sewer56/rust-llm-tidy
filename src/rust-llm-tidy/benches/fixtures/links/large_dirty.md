<!-- Benchmark fixture: Reloaded-III packaging tasks reference. -->
<!-- large tier; dirty for fix_links (six inline links repeat (Path, Id, TaskType, ...) and are hoisted). -->
<!-- Source (pinned): https://github.com/Reloaded-Project/Reloaded-III/blob/83e27e07332fbd8902273c639bdb8301ff1393ba/docs/Server/Packaging/Tasks.md -->
