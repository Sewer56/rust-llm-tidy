...
///
/// [`fix_fences`]: rust_llm_tidy::rules::transform::fix_fences
...
/// the tally.
///
/// [`fix_links`]: rust_llm_tidy::rules::transform::fix_links
#[allow(dead_code)] // each bench compiles `common` separately, using one set
pub const LINK_FIXTURES: &[(&str, &str)] = &[
    (
        "small/clean",
        include_str!("../fixtures/links/small_clean.md"),
    ),
    (
        "small/dirty",
        include_str!("../fixtures/links/small_dirty.md"),
    ),
    (
        "medium/clean",
    ...
    (
        "large/clean",
        include_str!("../fixtures/links/large_clean.md"),
    ),
    (
        "large/dirty",
        include_str!("../fixtures/links/large_dirty.md"),
    ),
...
pub const LINT_FIXTURES: &[(&str, &str)] = &[
    (
        "small/clean",
        include_str!("../fixtures/lint/small_clean.rs"),
    ),
    (
        "small/dirty",
        include_str!("../fixtures/lint/small_dirty.rs"),
    ),
    (
        "medium/clean",
    ...
    (
        "large/clean",
        include_str!("../fixtures/lint/large_clean.rs"),
    ),
    (
        "large/dirty",
        include_str!("../fixtures/lint/large_dirty.rs"),
    ),
];
