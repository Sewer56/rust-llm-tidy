...
//!
//! The text checks (TEXT001, TEXT002, TEXT003) follow from the same
//! parse's doc regions.
//!
//! # Semantics
//!
...
//! - TEXT001-TEXT003: `///` doc-comment prose measured with the XML doc
...
/// TEXT002, TEXT003) over the same parse's doc regions.
///
