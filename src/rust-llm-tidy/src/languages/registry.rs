...
//! - `text_lints`: how the TEXT001-TEXT003 text checks are sourced
//!
//! # Tiers
//!
...
//! # Text-lint tiers
//!
//! [`Profile::text_lints`] decides how a file's TEXT001-TEXT003 text
//! checks are sourced:
//!
...
pub(crate) struct Profile {
    ...
    /// producer.
    pub backend: bool,
    /// How the TEXT001-TEXT003 text checks are sourced for this profile.
    pub text_lints: TextLints,
}

/// How a profile's TEXT001-TEXT003 text checks are sourced.
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
