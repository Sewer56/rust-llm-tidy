# Ruby comment paragraph that runs past the 240 character budget on
...
quiet = "a long string of prose that would overflow both budgets if it were measured, but strings never measure"
