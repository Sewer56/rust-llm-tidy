; Elisp comment paragraph that runs past the 240 character budget on
...
(setq quiet "a long string of prose that would overflow if measured, but strings never measure")
