//! DOC010 out-of-canonical-order doc sections over the Rust fixtures.
//!
...
/// `save` in the fixture lists sections canonically and is not flagged.
#[test]
