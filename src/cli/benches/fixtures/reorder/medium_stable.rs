//! Benchmark fixture (derived): canonicalized reorder output of the medium clean file.
//! 506 lines, already in canonical order (reorder is a no-op).
//! Origin: Reloaded Search Engine `src/search.rs` (crate `reloaded-search-engine` by Sewer56; no public remote).
