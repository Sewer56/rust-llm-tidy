<!-- Benchmark fixture: slint Rust MCU docs. -->
<!-- large tier; clean for fix_links (single-use inline links only, borrowed no-op). -->
<!-- Source (pinned): https://github.com/slint-ui/slint/blob/90397064679ebcd86b5a1e698daeecf85c88820f/api/rs/slint/mcu.md -->
