<!-- Benchmark fixture: NexusMods.App developer index. -->
<!-- small tier; dirty for fix_links (two inline links repeat (Vortex, Wabbajack) and are hoisted). -->
<!-- Source (pinned): https://github.com/Nexus-Mods/NexusMods.App/blob/52206125e8924c6494aae4d3e3144bdde285037e/docs/developers/index.md -->
