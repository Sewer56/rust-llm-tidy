<!-- Benchmark fixture: slint ESP-IDF MCU docs. -->
<!-- medium tier; dirty for fix_links (one inline link repeats (Espressif IoT Development Framework) and is hoisted). -->
<!-- Source (pinned): https://github.com/slint-ui/slint/blob/90397064679ebcd86b5a1e698daeecf85c88820f/api/cpp/docs/mcu/esp_idf.md -->
