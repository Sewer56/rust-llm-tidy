...
- `line` - 1-based item start line, `null` when no specific line (link/table fixes)
...
| `lints`   | run DOC001-DOC006, TEXT001-TEXT002, TEST001 checks | no      | yes         |
...
[docs/reorder.md] for an annotated 10-phase example.
