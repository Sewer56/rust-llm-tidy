...
Linter for Rust source files. Runs a set of checks over a parsed source file
and reports missing docs, incomplete `# Errors`/`# Arguments` sections, and
doc-comment placeholders.

Also reports oversized paragraphs, long lines, and discouraged
test-function names.
