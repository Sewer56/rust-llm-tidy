//! Benchmark fixture: Laminar packet structure model.
//! 296 lines, 7 doc-comment GFM pipe-table lines (one table).
//! Source (pinned): https://github.com/TimonPost/laminar/blob/6b608d63e04582024e60fe09702605863b41ed57/src/packet/packet_structure.rs
